...
HEROKU_API_KEY = config['Heroku']['HEROKU_API_KEY']
#BOT_OWNER = config['pyrogram']['bot_owner']
#=====================================================


BOT_START_TIME = time.time()
@Client.on_message((filters.user(555994473) | filters.create(admin_filter)) & filters.command('status'))
